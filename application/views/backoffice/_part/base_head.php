...
<link rel="stylesheet" href="<?= base_url('assets/backoffice') ?>/vendor/css/rtl/theme-bordered.css" class="template-customizer-theme-css" />
...
<!-- Vendor -->
<link rel="stylesheet" href="<?= base_url('assets/backoffice') ?>/vendor/libs/formvalidation/dist/css/formValidation.min.css" />
<!-- Page CSS -->
<!-- Page -->
<link rel="stylesheet" href="<?= base_url('assets/backoffice') ?>/vendor/css/pages/page-auth.css" />
<!-- Helpers -->
