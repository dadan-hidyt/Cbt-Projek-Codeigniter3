<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold">SEBAYA CBT</span>
        </a>
    ...
    <ul class="menu-inner py-1">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="layouts-content-navbar-with-sidebar.html" class="menu-link">
                        <div data-i18n="Data Ujian">Data Ujian</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="../horizontal-menu-template" class="menu-link" target="_blank">
                        <div data-i18n="Data Mapel">Data Mapel</div>
                    </a>
                </li>
                <li class="menu-item">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Nilai Dan Ujian</span>
        </li>
        <li class="menu-item">
            <a href="app-email.html" class="menu-link">
                <i class="menu-icon tf-icons ti ti-list-details"></i>
                <div data-i18n="Kelola Soal">Kelola Soal</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="app-chat.html" class="menu-link">
                <i class="menu-icon tf-icons ti ti-checklist"></i>
                <div data-i18n="Kelola Ujian">Kelola Ujian</div>
            </a>
        </li>
        <li class="menu-item">
        ...
        <li class="menu-item">
            <a href="app-kanban.html" class="menu-link">
                ...
                <div data-i18n="Log Ujian">Log Ujian</div>
            </a>
        </li>
        ...
        <li class="menu-item">
            <a href="app-kanban.html" class="menu-link">
                ...
                <div data-i18n="Kelola Hasil Ujian">Kelola Hasil Ujian</div>
            </a>
        </li>
